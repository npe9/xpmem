...
xpmem_init(void)
{
	...
	/* printk debugging */
	/*debug_printk_entry = proc_create_data("debug_printk", 0644,
						xpmem_unpin_procfs_dir,
                        &xpmem_unpin_procfs_fops, NULL);
